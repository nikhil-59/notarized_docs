...
class _AmountScreenState extends State<AmountScreen>
  ...
  getData() async {
    ...
    map = await NotaryServices().getEarnings(widget.notaryId);
    print(map);
    setState(() {
      isloading = false;
    });
                            ...
                            child: InkWell(
                              ...
                              child: Card(
                                ...
                                child: Padding(
                                  ...
                                  child: ListTile(
                                    leading:
                                        map['notary']['userImageURL'] != null
                                            ? ClipRRect(
                                                borderRadius:
                                                    BorderRadius.circular(50),
                                                child: CachedNetworkImage(
                                                  imageUrl:
                                                      "${map['notary']['userImageURL']}",
                                                  height: 45,
                                                  width: 45,
                                                ),
                                              )
                                            : Container(),
                                    title: Text(
                                      "Refinance of ${map['notary']['firstName'] + " " + map['notary']['lastName']}",
                                      style: TextStyle(
                                          fontSize: 16.5,
